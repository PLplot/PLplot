...
csource_LIST="$csource_LIST bindings/tcl/*.[ch] bindings/f95/*.c bindings/old_f95/*.c bindings/old_f95/plstubs.h bindings/ocaml/plplot_impl.c bindings/ocaml/plcairo/plcairo_impl.c bindings/python/plplot_widgetmodule.c bindings/tk/*.[ch] bindings/tk-x-plat/*.[ch]"
