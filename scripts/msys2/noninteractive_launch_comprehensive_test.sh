# MinGW-w64/MSYS2:
# Run the non-interactive comprehensive tests and collect the output
#
# -----
...
$src/scripts/comprehensive_test.sh --generator_string "MSYS Makefiles" --cmake_added_options "-DCMAKE_CXX_FLAGS=-fabi-version=8" --build_command /usr/bin/make --ctest_command ctest --do_test_interactive no
