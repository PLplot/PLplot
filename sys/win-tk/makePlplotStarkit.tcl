...
file mkdir plplotter.vfs/lib/plplotter5.1.1
...
foreach f [glob -dir ../../lib *.{map,fnt}] {
    file copy $f plplotter.vfs/lib/plplotter5.1.1
}
...
file copy pkgIndex.tcl plplotter.vfs/lib/plplotter5.1.1
file copy tclIndex plplotter.vfs/lib/plplotter5.1.1
foreach f [glob *.dll] {
    file copy $f plplotter.vfs/lib/plplotter5.1.1
}
