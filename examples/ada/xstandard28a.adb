...
begin
    ...
    Set_Viewport_Normalized(-0.15, 1.15, -0.05, 1.05);
    Set_Viewport_World(-1.2, 1.2, -0.8, 1.5);
    Set_Up_3D(1.0, 1.0, 1.0, xmin, xmax, ymin, ymax, zmin, zmax, 20.0, 45.0);

    Set_Pen_Color(Yellow);
    Box_Around_Viewport_3D("b", "", xmax-xmin, 0, "b", "", ymax-ymin, 0, "bcd", "", zmax-zmin, 0);
    ...
    Set_Pen_Color(Yellow);
    Box_Around_Viewport_3D("b", "", xmax-xmin, 0,
      "b", "", ymax-ymin, 0,
      "bcd", "", zmax-zmin, 0);
    ...
    Set_Viewport_Normalized(-0.15, 1.15, -0.05, 1.05);
    Set_Viewport_World(-1.2, 1.2, -0.8, 1.5);
    Set_Up_3D(1.0, 1.0, 1.0, xmin, xmax, ymin, ymax, zmin, zmax, 40.0, -30.0);

    Set_Pen_Color(Yellow);
    Box_Around_Viewport_3D("b", "", xmax-xmin, 0, "b", "", ymax-ymin, 0, "bcd", "", zmax-zmin, 0);

    Set_Character_Height(0.0, 1.2);
    ...
    -- Page 5: Demonstrate Write_Text_Viewport_3D axis labelling capability.
    Advance_To_Subpage(Next_Subpage);
    Set_Viewport_Normalized(-0.15, 1.15, -0.05, 1.05);
    Set_Viewport_World(-1.2, 1.2, -0.8, 1.5);
    Set_Up_3D(1.0, 1.0, 1.0, xmin, xmax, ymin, ymax, zmin, zmax, 20.0, 45.0);
    ...
    Set_Character_Height(0.0, 1.0);
    Write_Text_Viewport_3D("xp",  3.0, 0.5, 0.5, "Arbitrarily displaced");
    Write_Text_Viewport_3D("xp",  4.5, 0.5, 0.5, "primary X-axis label");
    Write_Text_Viewport_3D("xs", -2.5, 0.5, 0.5, "Arbitrarily displaced");
    Write_Text_Viewport_3D("xs", -1.0, 0.5, 0.5, "secondary X-axis label");
    Write_Text_Viewport_3D("yp",  3.0, 0.5, 0.5, "Arbitrarily displaced");
    Write_Text_Viewport_3D("yp",  4.5, 0.5, 0.5, "primary Y-axis label");
    Write_Text_Viewport_3D("ys", -2.5, 0.5, 0.5, "Arbitrarily displaced");
    Write_Text_Viewport_3D("ys", -1.0, 0.5, 0.5, "secondary Y-axis label");
    Write_Text_Viewport_3D("zp",  4.5, 0.5, 0.5, "Arbitrarily displaced");
    Write_Text_Viewport_3D("zp",  3.0, 0.5, 0.5, "primary Z-axis label");
    Write_Text_Viewport_3D("zs", -2.5, 0.5, 0.5, "Arbitrarily displaced");
    Write_Text_Viewport_3D("zs", -1.0, 0.5, 0.5, "secondary Z-axis label");
