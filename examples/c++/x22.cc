...
x22::circulation()
{
    ...
    pls->col0( 2 );
    pls->vect( (const PLFLT **) u, (const PLFLT **) v, nx, ny, 0.0, plstream::tr2, (void *) &cgrid2 );
    pls->col0( 1 );
}
...
x22::constriction()
{
    ...
    pls->col0( 2 );
    pls->vect( (const PLFLT **) u, (const PLFLT **) v, nx, ny, -0.5, plstream::tr2, (void *) &cgrid2 );
    pls->col0( 1 );
}
...
x22::potential()
{
    ...
    pls->col0( 3 );
    pls->lsty( 2 );
    pls->cont( (const PLFLT **) z, nr, ntheta, 1, nr, 1, ntheta, clevel, nlevel, plstream::tr2, (void *) &cgrid2 );
    pls->lsty( 1 );
    pls->col0( 1 );

    // Plot the vectors of the gradient of the potential
    pls->col0( 2 );
    pls->vect( (const PLFLT **) u, (const PLFLT **) v, nr, ntheta, 25.0, plstream::tr2, (void *) &cgrid2 );
    pls->col0( 1 );
