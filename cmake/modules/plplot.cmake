...
if(NOT HAVE_FINITE)
  ...
  if(HAVE_FINITE2)
    ...
    if(NOT _HAVE_FINITE)
      ...
      if(_HAVE_FINITE2)
        set(_HAVE_FINITE ${_HAVE_FINITE2} CACHE INTERNAL "Have function _finite")
...
if(NOT HAVE_ISNAN)
  check_function_exists(isnan HAVE_ISNAN2)
  if(HAVE_ISNAN2)
    set(HAVE_ISNAN ${HAVE_ISNAN2} CACHE INTERNAL "Have function isnan")
  else(HAVE_ISNAN2)
    check_symbol_exists(_isnan "math.h" _HAVE_ISNAN)
    if(NOT _HAVE_ISNAN)
      check_function_exists(_isnan _HAVE_ISNAN2)
      if(_HAVE_ISNAN2)
        set(_HAVE_ISNAN ${_HAVE_ISNAN2} CACHE INTERNAL "Have function _isnan")
        set(HAVE_ISNAN ${_HAVE_ISNAN} CACHE INTERNAL "Have function _isnan")
      endif(_HAVE_ISNAN2)
      set(_HAVE_ISNAN2 "" CACHE INTERNAL "Have function _isnan")
    endif(NOT _HAVE_ISNAN)
  endif(HAVE_ISNAN2)
  set(HAVE_ISNAN2 "" CACHE INTERNAL "Have function isnan")
endif(NOT HAVE_ISNAN)

check_symbol_exists(ising "math.h" HAVE_ISINF)
if(NOT HAVE_ISINF)
  check_function_exists(ising HAVE_ISINF2)
  if(HAVE_ISINF2)
    set(HAVE_ISINF ${HAVE_ISINF2} CACHE INTERNAL "Have function ising")
  else(HAVE_ISINF2)
    check_symbol_exists(_ising "math.h" _HAVE_ISINF)
    if(NOT _HAVE_ISINF)
      check_function_exists(_ising _HAVE_ISINF2)
      if(_HAVE_ISINF2)
        set(_HAVE_ISINF ${_HAVE_ISINF2} CACHE INTERNAL "Have function _ising")
        set(HAVE_ISINF ${_HAVE_ISINF} CACHE INTERNAL "Have function _ising")
      endif(_HAVE_ISINF2)
      set(_HAVE_ISINF2 "" CACHE INTERNAL "Have function _ising")
    endif(NOT _HAVE_ISINF)
  endif(HAVE_ISINF2)
  set(HAVE_ISINF2 "" CACHE INTERNAL "Have function ising")
