...
if(HAVE_QHULL OR WITH_CSA)
  ...
  if(NOT DEFINED NaNAwareCCompiler)
    ...
    CMAKE_FLAGS -DCOMPILE_DEFINITIONS:STRING=${NAN_CFLAGS}
...
if(HAVE_QHULL)
  find_library(QHULL_LIB qhull /usr/local/lib /usr/lib)
  if(QHULL_LIB)
    include(CheckFunctionExists)
    set(CMAKE_REQUIRED_LIBRARIES ${QHULL_LIB})
    check_function_exists(qh_new_qhull QH_NEW_VARIABLE)
    set(CMAKE_REQUIRED_LIBRARIES)
    if(QH_NEW_VARIABLE)
      include(CheckIncludeFile)
      check_include_file("qhull/qhull_a.h" QHULL_INCLUDE)
      if(NOT QHULL_INCLUDE)
        message(STATUS "WARNING: Setting HAVE_QHULL to OFF.")
        set(HAVE_QHULL OFF CACHE BOOL "Enable use of the Qhull library" FORCE)
      endif(NOT QHULL_INCLUDE)
    else(QH_NEW_VARIABLE)
      message(STATUS "WARNING: Setting HAVE_QHULL to OFF.")
      set(HAVE_QHULL OFF CACHE BOOL "Enable use of the Qhull library" FORCE)
    endif(QH_NEW_VARIABLE)
  else(QHULL_LIB)
    message(STATUS 
