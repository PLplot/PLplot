 ...
 * start by calling this function */
{
	...
	if (!cdImageSetSize(im, sx,sy)) {free (im);return 0;}
 ...
 */
	...
	if (!cdcomhead(es, 5, 2, 2)) {free(esp); return 0;}
	es += 2;
 ...
 */
	...
	if (im->linespec) {
		if (!cdcomhead(es, 5, 3, 4)) {free(esp);return 0;}
		es += 2;
		octet_count = 2;
		...
		if (!cdcomhead(es, 5, 3, 2)) {free(esp);return 0;}
		octet_count = 2;
		es += 2;
		es += cdAppShort(es, (short int) lnwidth);
		octet_count += 2;
 ...
 */
	...
	if (!cdcomhead(es, 5, 4, 1)) {free (esp);return 0;}
	es += 2;
 ...
 */
	...
	if (!cdcomhead(es, 5, 22, 2)) {free (esp);return 0;}
	es += 2;
 ...
 */
	...
	if (!cdcomhead(es, 5, 23, 1)) {free(esp);return 0;}
	es += 2;
 ...
 */
	...
	if (!cdcomhead (es, 5, 24, 2)) {free(esp);return 0;}
	es += 2;
 ...
 */
	...
	if(!cdcomhead(es, 5, 27, 2)) {free(esp);return 0;}
	es += 2;
 ...
 */
	...
	if (im->edgespec) {
		if (!cdcomhead(es, 5, 28, 4)) {free(esp);return 0;}
		es += 2;
		octet_count = 2;
		...
		if (!cdcomhead(es, 5, 28, 2)) {free(esp);return 0;}
		es += 2;
		octet_count = 2;
		es+= cdAppShort(es, edwidth);
		octet_count+=2;
 ...
 */
	...
	if (!es) return 0; /* memory allocation failed */
	esp=es;
	if (!cdcomhead(es, 5, 29, 1)) {free(esp);return 0;}
	es += 2;
 ...
 */
	...
	if (!cdcomhead(es, 5, 30, 2)) {free(esp);return 0;}
	es +=2; octet_count = 2;
	temp = edvis >> 8;
	*es = *es | (temp & 0377);
	es++;
 ...
 */
	...
	if(!cdcomhead(es, 5, 10, 2)) {free(esp);return 0;}
	es += 2;
 ...
 */
	...
	if(!cdcomhead(es, 5, 14, 1)) {free(esp);return 0;}
	es += 2; 
 ...
 */
	...
	if(!cdcomhead(es, 5, 15, 2)) {free(esp);return 0;}
	octet_count = 2; es += 2;
 ...
 */
	...
	if (!cdcomhead(es, 5, 17, 2)) {free(esp);return 0;}
	es +=2; octet_count = 2;
 ...
 */
	...
	if (!cdcomhead(es, 5, 16, 8)) {free(esp);return 0;}
	es +=2; octet_count += 2;
 ...
 */
	...
	if (!cdcomhead(es, 5, 6, 2)) {free(esp); return 0;}
	es += 2;
	/* set Param_List_Len to 2 (signed int at index precision) */
 ...
 */
	...
	if (im->markerspec) {
		if (!cdcomhead(es, 5, 7, 4)) {free(esp);return 0;}
		octet_count = 2;
		es += 2;
 ...
 */
	...
	if (!cdcomhead(es, 5, 8, 1)) {free (esp);return 0;}
	es += 2;
 ...
 */
{
	...
	/* we can use the short form of the command */
 		/* allocate sufficent space. Should be 32 bits * 10 to be safe*/
        	...
        	ctsp=cts;
		if (!cdcomhead(ctsp,5,34,(numco*3)+1)) {free(cts); return -1;}
	...
	/* we must use the long form of the command */
 		/* allocate sufficent space. Should be 32 bits*256 to be safe*/
        	...
        	if (!cts) return -1; /* memory allocation failed */
        	ctsp=cts;
		if (!cdcomheadlong(ctsp,5,34,(numco*3)+1)){free(cts);return -1;}
 ...
 */
{
	...
	if (!cdcomhead(es, 4, 1, 8)) {free(esp);return 0;}
	es += 2;
	octet_count = 2;
 ...
 */
{
	...
	if (!cdcomhead(es, 4, 3, 4)) {free(esp);return 0;}
	es += 2;
	octet_count = 2;
 ...
 */
	...
	if (!cdcomhead(es, 4, 11, 8)) {free(esp);return 0;}
	es +=2; octet_count = 2;
 ...
 */
	...
	if (!cdcomhead(es, 4, 12, 6)) {free(esp);return 0;}
	es +=2; octet_count = 2;
 ...
 */
	...
	if (!cdcomhead(es, 4, 13, 12)) {free(esp);return 0;}
	es +=2; octet_count = 2;
 ...
 */
	...
	if (!cdcomhead(es, 4, 14, 14)) {free(esp);return 0;}
	es +=2; octet_count = 2;
 ...
 */
	...
	/* their are six 16 bit signed integers as attributes */
	if (!cdcomhead(es, 4, 17, 12)) {free(esp);return 0;}
	es +=2; octet_count = 2;
 ...
 */
	 ...
	 * add it right now, shall we? */
		...
		if (!cdcomhead(es, 4, 7, (n*4))) {free(esp);return 0;}
		es +=2; octet_count = 2;
	 ...
	 */
		...
		if (!cdcomheadlong(es, 4, 7, (n*4))) {free(esp);return 0;}
		es +=4; octet_count = 4;
	}
	else {
 ...
 */
	 ...
	 * add it right now, shall we? */
		...
		/* their are n*2 16 bit signed integers as attributes */
		if (!cdcomhead(es, 4, 8, (n*6))) {free(esp);return 0;}
		es +=2; octet_count = 2;
	 ...
	 */
		...
		if (!cdcomheadlong(es, 4, 8, (n*6))) {free(esp);return 0;}
		es +=4; octet_count = 4;
	}
	else {
 ...
 */
	 ...
	 * add it right now, shall we? */
		...
		/* their are n*2 16 bit signed integers as attributes */
		if (!cdcomhead(es, 4, 1, (n*4))) {free(esp);return 0;}
		es +=2; octet_count = 2;
	 ...
	 */
		...
		if (!cdcomheadlong(es, 4, 1, (n*4))) {free(esp);return 0;}
		es +=4; octet_count = 4;
	}
	else {
	/* there are more than 8191 points in it, I am not going to implement
 ...
 */
	 ...
	 * add it right now, shall we? */
		...
		/* their are n*2 16 bit signed integers as attributes */
		if (!cdcomhead(es, 4, 3, (n*4))) {free(esp);return 0;}
		es +=2; octet_count = 2;
	 ...
	 */
		...
		if (!cdcomheadlong(es, 4, 3, (n*4))) {free(esp);return 0;}
		es +=4; octet_count = 4;
	}
	else {
	/* there are more than 8191 points in it, I am not going to implement
 ...
 */
	...
	if (!cdcomheadlong(es, 4, 4, 9+tslen)) {free(esp);return 0;}
	es +=4; octet_count = 4;
 ...
 * the "expert" functions, you should call this first. _ge */
{
	...
	if (!im->elemlist) {free(im);return 0;} /* memory allocation failed */
	im->colorsTotal = 0;
...
/* close the current picture */
{
	...
	if (!cdcomhead(es, 0, 5, 0)) {free(esp); return 0;}
	octet_count += 2;
