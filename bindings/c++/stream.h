...
/* Retrieve current window into device space */
    ...
    void gdidev( PLFLT *p_mar, PLFLT *p_aspect, PLFLT *p_jx, PLFLT *p_jy );

/* Get plot orientation */

    void gdiori( PLFLT *p_rot );

/* Retrieve current window into plot space */

    void gdiplt( PLFLT *p_xmin, PLFLT *p_ymin, PLFLT *p_xmax, PLFLT *p_ymax );

/* Get family file parameters */

    void gfam( PLINT *p_fam, PLINT *p_num, PLINT *p_bmax );
...
/* Get output device parameters. */
    ...
    void gpage( PLFLT *p_xp, PLFLT *p_yp, PLINT *p_xleng, PLINT *p_yleng,
...
/* Get x axis labeling parameters */
    ...
    void gxax( PLINT *p_digmax, PLINT *p_digits );

/* Get y axis labeling parameters */

    void gyax( PLINT *p_digmax, PLINT *p_digits );
