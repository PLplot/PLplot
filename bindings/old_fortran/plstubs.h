...
#define FNAME( x, y )     PLDLLIMPEXP_FORTRANC y ## _
...
#define FNAME( x, y )     PLDLLIMPEXP_FORTRANC __stdcall x
#define FNAME_( x, y )    x
...
#define FNAME( x, y )     PLDLLIMPEXP_FORTRANC x
#define FNAME_( x, y )    x
...
#define    PLBIN                     FNAME( PLBINFortran, plbinfortran )
...
#define    PLCPSTRM                  FNAME( PLCPSTRMFortran, plcpstrmfortran )
...
#define    PLERRX                    FNAME( PLERRXFortran, plerrxfortran )
#define    PLERRY                    FNAME( PLERRYFortran, plerryfortran )
#define    PLFAMADV                  FNAME( PLFAMADV, plfamadv )
#define    PLFILL                    FNAME( PLFILLFortran, plfillfortran )
#define    PLFILL3                   FNAME( PLFILL3Fortran, plfill3fortran )
...
#define    PLGRADIENT                FNAME( PLGRADIENTFortran, plgradientfortran )
#define    PLGRIDDATA                FNAME( PLGRIDDATAFortran, plgriddatafortran )
...
#define    PLHIST                    FNAME( PLHISTFortran, plhistfortran )
#define    PLHLSRGB                  FNAME( PLHLSRGB, plhlsrgb )
#define    PLIMAGE                   FNAME( PLIMAGEFortran, plimagefortran )
...
#define    PLLINE                    FNAME( PLLINEFortran, pllinefortran )
#define    PLLINE3                   FNAME( PLLINE3Fortran, plline3fortran )
...
#define    PLMESH                    FNAME( PLMESHFortran, plmeshfortran )
#define    PLMESHC                   FNAME( PLMESHCFortran, plmeshcfortran )
#define    PLMKSTRM                  FNAME( PLMKSTRM, plmkstrm )
#define    PLMTEX7                   FNAME( PLMTEX7, plmtex7 )
#define    PLMTEX37                  FNAME( PLMTEX37, plmtex37 )
#define    PLOT3D                    FNAME( PLOT3DFortran, plot3dfortran )
#define    PLOT3DC                   FNAME( PLOT3DCFortran, plot3dcfortran )

#if STUB_LINKAGE == STUB_STDCALL || STUB_LINKAGE == STUB_FORTRAN
#define    CALL_PLOT3DC              PLOT3DCFortran
#elif  STUB_LINKAGE == STUB_LAU
#define    CALL_PLOT3DC              plot3dcfortran_
#else
...
#define    PLPOIN                    FNAME( PLPOINFortran, plpoinfortran )
#define    PLPOIN3                   FNAME( PLPOIN3Fortran, plpoin3fortran )
#define    PLPOLY3                   FNAME( PLPOLY3Fortran, plpoly3fortran )
...
#define    PLRANDD                   FNAME( PLRANDDFortran, plranddfortran )
#define    PLREPLOT                  FNAME( PLREPLOT, plreplot )
#define    PLRGBHLS                  FNAME( PLRGBHLS, plrgbhls )
#define    PLSCHR                    FNAME( PLSCHR, plschr )
#define    PLSCMAP0                  FNAME( PLSCMAP0Fortran, plscmap0fortran )
#define    PLSCMAP0A                 FNAME( PLSCMAP0AFortran, plscmap0afortran )
#define    PLSCMAP0N                 FNAME( PLSCMAP0N, plscmap0n )
#define    PLSCMAP1                  FNAME( PLSCMAP1Fortran, plscmap1fortran )
#define    PLSCMAP1A                 FNAME( PLSCMAP1AFortran, plscmap1afortran )
#define    PLSCMAP1L                 FNAME( PLSCMAP1LFortran, plscmap1lfortran )
#define    PLSCMAP1L2                FNAME( PLSCMAP1L2Fortran, plscmap1l2fortran )
#define    PLSCMAP1LA                FNAME( PLSCMAP1LAFortran, plscmap1lafortran )
#define    PLSCMAP1LA2               FNAME( PLSCMAP1LA2Fortran, plscmap1la2fortran )
...
#define    PLSPAUSE                  FNAME( PLSPAUSEFortran, plspausefortran )
...
#define    PLSTRIPC                  FNAME( PLSTRIPCFortran, plstripcfortran )
#define    PLSTRIPD                  FNAME( PLSTRIPD, plstripd )
#define    PLSTYL                    FNAME( PLSTYL, plstyl )
#define    PLSURF3D                  FNAME( PLSURF3DFortran, plsurf3dfortran )
#define    PLSURF3DL                 FNAME( PLSURF3DLFortran, plsurf3dlfortran )
#define    PLSVECT1                  FNAME( PLSVECT1Fortran, plsvect1fortran )
...
#define    PLSYM                     FNAME( PLSYMFortran, plsymfortran )
...
#define    PLXORMOD                  FNAME( PLXORMODFortran, plxormodfortran )
