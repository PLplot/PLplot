/*
 * This is the massaged plplot.h file from the plplot-961023 snapshot
 *	distribution, plus the plplot-961023 patches.
 *	It can be found at
 *		ftp://dino.ph.utexas.edu/plplot/snapshots
*/
 ...
 *
 * Revision 1.1.1.1  2000/04/10 17:23:06  qual
 * import  module
 *
...
#define PLESC_XORMOD		15	/* jc: set xor mode */
...
void c_plmap(void (*mapform)(PLINT, PLFLT *, PLFLT *), char *type,
      PLFLT minlong, PLFLT maxlong, PLFLT minlat, PLFLT maxlat); //%nowrap

/* Plot the latitudes and longitudes on the background. */

void c_plmeridians(void (*mapform)(PLINT, PLFLT *, PLFLT *), 
...
int my_plGetCursor(int *state, int *keysym, int *button, char *string, int *pX, int *pY, float *dX, float *dY, PLFLT *wX, PLFLT *wY) {
	PLGraphicsIn gin;
