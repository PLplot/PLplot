...
#define    PLHLS_RGB    FNAME(PLHLS_RGB,plhls_rgb)
#define    PLHLS_RGBa   FNAME(PLHLS_RGB,plhls_rgb_)
...
#define    PLRGB_HLS    FNAME(PLRGB_HLS,plrgb_hls)
#define    PLRGB_HLSa   FNAME(PLRGB_HLS,plrgb_hls_)
