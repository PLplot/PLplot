...
--------- Simple color table manipulatons -----
    ...
    type Color_Themes_For_Map_1_Type is (Gray, Blue_Green_Red, Red_Green_Blue, Red_Cyan_Blue, Blue_Black_Red, Red_Blue_Green, Red_Yellow);
...
-- These correspond to the section in plot.h called "Function Prototypes".
    ...
    -- plend1
    procedure Plot_End_Current_Stream;
