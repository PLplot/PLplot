      ...
      integer, parameter :: PL_COLORBAR_LEFT = 1 
      integer, parameter :: PL_COLORBAR_RIGHT = 2 
      integer, parameter :: PL_COLORBAR_UPPER = 4 
      integer, parameter :: PL_COLORBAR_LOWER = 8 
      integer, parameter :: PL_COLORBAR_LABEL_LEFT = 16 
      integer, parameter :: PL_COLORBAR_LABEL_RIGHT = 32 
      integer, parameter :: PL_COLORBAR_LABEL_UPPER = 64 
      integer, parameter :: PL_COLORBAR_LABEL_LOWER = 128 
