...
#define    PLGRADIENT                FNAME( PLGRADIENTF77, plgradientf77 )
...
#define    PLSTRANSFORMON            FNAME( PLSTRANSFORMON, plstransformon )
#define    PLSTRANSFORMOFF           FNAME( PLSTRANSFORMOFF, plstransformoff )
