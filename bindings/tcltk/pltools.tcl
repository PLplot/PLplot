...
#
# 
# Revision 1.17  1998 Vince.
# Removed very old 'class' and 'destroy' procs.  These were messing
# everything up when they were loaded accidentally.
# 
...
proc getSaveFile {devkey} {
	...
	fileselectionbox .fs -title "Enter file name" 
	
	#-full 0 -filter $filter
	.fs activate
	# don't think this the 'proper' way to do this
	while {[winfo viewable .fs]} { update }
	set file [.fs get]
